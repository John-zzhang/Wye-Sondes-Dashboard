...
# UI component
elementComparisonUI2 <- function(id){
     ns <- NS(id)
...
# Exploration Server
elementComparisonServer2 <- function (input,output,session){
        ...
        # update the SelectizeInput
         ...
         output$plot2 <- renderPlotly({
          ...
          for (i in 1:n)
          {
            ...
            plot_list[[i]] <- plotly_build(plot_ly(data = sampleData2, 
                ...
                layout(
                   ...
                   yaxis = list(title = list(text = as.character(input$variable2[[i]]),
                                             font = list(size = 10)),
                               font = list(
                                family = "Courier New, monospace",
                                size = 10,
...
shinyApp(elementComparisonUI2,elementComparisonServer2)
